...
parser_add_member.add_argument("username", help="Username or ID of user")
...
parser_remove_member.add_argument("username", help="Username or ID of user")
...
parser_update_member.add_argument("username", help="Username or ID of user")
